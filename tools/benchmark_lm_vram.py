...
def main():
    ...
    try:
        ...
        audio = model(
            ...
            enable_lm_block_swap=bool(preset.get("enable_lm_block_swap", True)),
            lm_blocks_to_swap=_safe_int(preset.get("lm_blocks_to_swap", 17), 17),
            lm_sub_blocks_to_swap=_safe_int(preset.get("lm_sub_blocks_to_swap", 5), 5),
            lm_block_swap_use_pinned=bool(preset.get("lm_block_swap_use_pinned", False)),
