...
def generate_single_song(model, params, progress_tracker=None, cancellation_token=None):
    ...
    audio_data = model(
        ...
        enable_lm_block_swap=params.get('enable_lm_block_swap', False),
        enable_lm_mlp_int8=params.get('enable_lm_mlp_int8', False),
        enable_lm_mlp_int4=params.get('enable_lm_mlp_int4', False),
